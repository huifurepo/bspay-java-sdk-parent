...
import com.huifu.bspay.sdk.opps.core.request.V2LinkappStoreBindRequest;
 ...
 * @Description
 */
@Identify(requestClass = V2LinkappStoreBindRequest.class)
public class V2LinkappStoreBindRequestDemo extends BaseCommonDemo {
