...
public class V2MerchantBusiModifyRequestDemo extends BaseCommonDemo {
    ...
    private static Map<String, Object> getExtendInfos() {
        ...
        // *协议信息实体*
        extendInfoMap.put("agreement_info", getF84913680c03457b8db61525dd991f4b());
        // 是否交易手续费外扣
        ...
        // 线上费率配置
        // extendInfoMap.put("online_fee_conf_list", get3bd184aaA524464d98e0026dc603b034());
        // 支付宝配置对象
        extendInfoMap.put("ali_conf_list", get6fb528521f204a569b6cC2d508ef033f());
        // 微信配置对象
        extendInfoMap.put("wx_conf_list", get5f363a049c6344c190a5Bb8d4d4185c1());
        // 银联二维码配置对象
        extendInfoMap.put("union_conf_list", getF898d387213844e897edE215a8aa1e0b());
        // 银行卡支付配置信息
        extendInfoMap.put("bank_card_conf", getA2047d83E3554a3b97df5ab8fb55c518());
        // *余额支付配置对象*
        extendInfoMap.put("balance_pay_config", getE79b7d924a7646668397B0990d1a5f7e());
        // 补贴支付
        extendInfoMap.put("combine_pay_config", getC361e46dB849469dAd8220014017a774());
        // 线上手续费承担方配置
        // extendInfoMap.put("online_pay_fee_conf_list", get3a0cf7530f03464a85c54dc503846b41());
        // 全域资金管理配置(华通银行)
        // extendInfoMap.put("out_order_funds_config", get1b77197a01b34d3dBbb4Cd225d00690b());
        // 汇总结算配置实体
        // extendInfoMap.put("collection_settle_config_list", getEc599ff5Cb16496f86b54177ffe40dfc());
        // 异步消息接收地址
        ...
        // *运营媒介*
        // extendInfoMap.put("online_media_info_list", get922eb3ea68ea432bB1bf35b69f61e0a6());
        // *补充文件信息*
        // extendInfoMap.put("extended_material_list", get454985dfB04f4acbB5307dc11c687539());
        // 商户开通强制延迟标记
        // extendInfoMap.put("forced_delay_flag", "");
        // 微信直连配置对象
        // extendInfoMap.put("wx_zl_conf", getE919e1a34c884ea19444Ab5d2c9e29b0());
        // 支付宝直连配置对象
        // extendInfoMap.put("ali_zl_conf", get702f1760F9724eb59b8c5f6df0023fa3());
        // 开户费用值(元)
        ...
        // 分账配置信息
        // extendInfoMap.put("split_conf_info", getFfc714254d17425b91e57437b2a4890f());
        // 银联线上收银台
        // extendInfoMap.put("uni_app_payment_config", get49a0d782Bdd0422bA39aEd2d9385b4ee());
        // 资金归集开通标记
        // extendInfoMap.put("fund_collection_flag", "");
        // 代发配置
        // extendInfoMap.put("surrogate_config_list", getA47058c033c547588310Ea96eddd0085());
        // 大额支付配置
        // extendInfoMap.put("large_amt_pay_config", get0b897dffA67b4c19Af07Ad3ab3bd9c81());
        // 托管支付开关
        // extendInfoMap.put("half_pay_host_flag", "");
        // 代发复核配置
        // extendInfoMap.put("agent_recheck_config", get8eeb2b9c732b442a95cd9519cc5f4714());
    ...
    private static String get22028d120f864b80901c70d76db8bb7f() {
        ...
        // 联系人信息对象
        // dto.put("contact_person_info", getEba9eef48b184bfeA5eb16e305f4fede());
        // 法人身份信息
        // dto.put("legal_person_info", get312ba9820afb4b35943cE00e7517a56b());
    ...
    private static String get6fb528521f204a569b6cC2d508ef033f() {
        ...
        // 实名认证信息
        // dto.put("al_real_name_info", get22028d120f864b80901c70d76db8bb7f());
    ...
    private static JSON get794c253c86ac49c0B843353029f16f4b() {
        JSONObject dto = new JSONObject();
    ...
    private static String get5f363a049c6344c190a5Bb8d4d4185c1() {
        ...
        // dto.put("is_check_real_name", "");
        // 实名认证信息
        // dto.put("wx_real_name_info", get794c253c86ac49c0B843353029f16f4b());
    ...
    private static JSON get5b99b095D426451284d651d6d4551317() {
        JSONObject dto = new JSONObject();
        // *业务模式说明*
    ...
    private static String getE79b7d924a7646668397B0990d1a5f7e() {
        ...
        // *业务情况说明*
        // dto.put("description_info", get5b99b095D426451284d651d6d4551317());
        // 支付手续费(%)
        dto.put("fee_rate", "2");
        // 支付固定手续费(元)
    ...
    private static JSON get8afb031299c74b57B44a0fccb3c3453b() {
        JSONObject dto = new JSONObject();
        // 结算账户名
    ...
    private static JSON getBb45b3ab4acf492dA4b247d8889c32ec() {
        JSONObject dto = new JSONObject();
        // 开户手续费(元)
    ...
    private static String get1b77197a01b34d3dBbb4Cd225d00690b() {
        ...
        // dto.put("out_fee_huifuid", "");
        // 全域资金开户使用的银行卡信息
        // dto.put("out_order_acct_card", get8afb031299c74b57B44a0fccb3c3453b());
        // 全域资金开户手续费
        // dto.put("out_order_acct_open_fees", getBb45b3ab4acf492dA4b247d8889c32ec());
        // 全域支付业务模式
    ...
    private static JSON get105bb4fe13ef462a8d4aEef2c211b94b() {
        JSONObject dto = new JSONObject();
        // 文件类型
    ...
    private static JSON getDe1af8a5D5fb4b13B4c164130dd2df78() {
        JSONObject dto = new JSONObject();
        // 联系人类型
        ...
        // dto.put("contact_file_list", get105bb4fe13ef462a8d4aEef2c211b94b());
        // 证件有效期类型
    ...
    private static JSON getBb43ce04548043f0989d60e06e893a2a() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static JSON get267843a2B5894c648c1a699b66c27614() {
        JSONObject dto = new JSONObject();
        // 登记证书类型
        // dto.put("cert_type", "test");
        // 证书号
        ...
        // dto.put("cert_begin_date", "test");
        // 文件列表
        // dto.put("cert_file_list", getBb43ce04548043f0989d60e06e893a2a());
        // 证书有效期截止日期
    ...
    private static JSON get5cb9d76cAbfb4c188b2c2e88e663cf71() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static JSON get62188ac863444f7d9f6c435d94715d55() {
        JSONObject dto = new JSONObject();
        // 证件类型
        ...
        // 文件列表
        // dto.put("ubo_file_list", get5cb9d76cAbfb4c188b2c2e88e663cf71());
        // 证件有效期截止日期
    ...
    private static JSON get57fadb91Fb744fa0B1f5A90f0adb128f() {
        JSONObject dto = new JSONObject();
        // 经营者/法人是否为受益人
        // dto.put("ubo_type", "test");
        // 受益人信息列表jsonArray格式,当ubo_type为Y时可不填
        // dto.put("ubo_info_list", get62188ac863444f7d9f6c435d94715d55());

        return dto;
    }

    private static JSON getEff6f68bAfcf4938873474694dab163e() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static JSON getF9141064A3f84adcB761655842ac36bc() {
        JSONObject dto = new JSONObject();
        // 经营场景类型
        ...
        // 文件列表
        // dto.put("sales_scenes_file_list", getEff6f68bAfcf4938873474694dab163e());
        // 文件列表
    ...
    private static JSON get11eb5ca8C5754b8e9aca2ead85fc214e() {
        JSONObject dto = new JSONObject();
        // 账户类型
        // dto.put("card_type", "test");
        // 开户名称
    ...
    private static JSON get538080223b4a4796A1be9e00e1fb1ee9() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static JSON getAcf3bcf2Cefc4c4eB3d95fd31174a3ec() {
        JSONObject dto = new JSONObject();
        // 申请服务
        ...
        // dto.put("contact_info", getDe1af8a5D5fb4b13B4c164130dd2df78());
        // 特殊主体登记证书jsonObject字符串，商户营业执照类型为政府机关/事业单位/其他组织时，传入相应信息。新增时需填入
        // dto.put("certificate_info", get267843a2B5894c648c1a699b66c27614());
        // 最终受益人信息jsonObject字符串，商户类型为企业时，微信侧必填。（如果基本信息里有的话，可以不传取 huifu_id 对应的信息）。新增时填入
        // dto.put("ubo_info", get57fadb91Fb744fa0B1f5A90f0adb128f());
        // 经营场景jsonObject字符串，新增时填入
        // dto.put("sales_info", getF9141064A3f84adcB761655842ac36bc());
        // 银行账户信息jsonObject字符串，该字段不填时，取商户在汇付系统录入的结算账号信息。新增或修改时填入，修改时必填
        // dto.put("wx_card_info", get11eb5ca8C5754b8e9aca2ead85fc214e());
        // 补充说明信息
        // dto.put("business_addition_msg", "");
        // 补充说明文件列表
        // dto.put("addition_file_list", get538080223b4a4796A1be9e00e1fb1ee9());
    ...
    private static String getE919e1a34c884ea19444Ab5d2c9e29b0() {
        ...
        // 配置集合
        // dto.put("wx_zl_pay_conf_list", getAcf3bcf2Cefc4c4eB3d95fd31174a3ec());

        return dto.toJSONString();
    }

    private static JSON get70ddacc08d8d4fceBc5819b47a9d2944() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static String get702f1760F9724eb59b8c5f6df0023fa3() {
        ...
        // dto.put("fee_rate", "test");
        // 文件列表
        // dto.put("file_list", get70ddacc08d8d4fceBc5819b47a9d2944());
        // 联系人姓名
    ...
    private static JSON getDb9ac880Bcb249dbA5ef1c446504e5d3() {
        JSONObject dto = new JSONObject();
        // 分账比例
        // dto.put("fee_rate", "test");
        // 汇付Id
    ...
    private static JSON get71489064F152485b9400E68d45d8c777() {
        JSONObject dto = new JSONObject();
        // *业务模式说明*
        // dto.put("busi_instruction", "test");
        // *资金流向说明*
    ...
    private static String getFfc714254d17425b91e57437b2a4890f() {
        ...
        // dto.put("scene", "test");
        // 分账明细
        // dto.put("acct_split_bunch_list", getDb9ac880Bcb249dbA5ef1c446504e5d3());
        // 交易手续费外扣开关
        // dto.put("out_fee_flag", "");
        // 交易手续费外扣时的账户类型
        // dto.put("out_fee_acct_type", "");
        ...
        // dto.put("per_amt", "");
        // 业务情况说明
        // dto.put("split_ext_info", get71489064F152485b9400E68d45d8c777());
    ...
    private static JSON get45490f78669d4987B4067b0396abf30d() {
        JSONObject dto = new JSONObject();
        // 大额支付业务模式
    ...
    private static String get0b897dffA67b4c19Af07Ad3ab3bd9c81() {
        JSONObject dto = new JSONObject();
        // 大额支付配置列表
        // dto.put("large_amt_pay_config_info_list", get45490f78669d4987B4067b0396abf30d());
    ...
    private static JSON get8eeb2b9c732b442a95cd9519cc5f4714() {
        JSONObject dto = new JSONObject();
        // 代发复核开关
