...
public class V2MerchantBusiModifyRequestDemo extends BaseCommonDemo {
    ...
    private static Map<String, Object> getExtendInfos() {
        ...
        // *协议信息实体*
        extendInfoMap.put("agreement_info", get22bd128802024820B0c3A1d120b9a9a6());
        // 是否交易手续费外扣
        ...
        // 线上费率配置
        // extendInfoMap.put("online_fee_conf_list", get1022d935945b49b289345deacaf1ce83());
        // 支付宝配置对象
        extendInfoMap.put("ali_conf_list", get8cfab2faCfe44ae0B21a794e75bd4bd8());
        // 微信配置对象
        extendInfoMap.put("wx_conf_list", get5d5a576915a445fdB6a4201f194bf3e1());
        // 银联二维码配置对象
        extendInfoMap.put("union_conf_list", getDaaf08c0F62444fb91552a567b0c9ace());
        // 银行卡支付配置信息
        extendInfoMap.put("bank_card_conf", getCf413b0e29154766Ac1aEbe329257692());
        // *余额支付配置对象*
        extendInfoMap.put("balance_pay_config", get5143e4b430fc47908ac1C2d209773271());
        // 补贴支付
        extendInfoMap.put("combine_pay_config", getE0fa63b7868e407dBa7c6da7f4603794());
        // 线上手续费承担方配置
        // extendInfoMap.put("online_pay_fee_conf_list", getB57b637081014a34A512Bb04f895746e());
        // 全域资金管理配置(华通银行)
        // extendInfoMap.put("out_order_funds_config", get9f4ff903Cbec412f9536Dd84c72974d8());
        // 汇总结算配置实体
        // extendInfoMap.put("collection_settle_config_list", get2cc315bbF4dd4348B2f870c88adf936c());
        // 异步消息接收地址
        ...
        // *运营媒介*
        // extendInfoMap.put("online_media_info_list", get24eee2eb4b1742b2B5d0Ea330c78abd8());
        // *补充文件信息*
        // extendInfoMap.put("extended_material_list", getA9f8b51867f3429181a33dc1de9b9010());
        // 商户开通强制延迟标记
        // extendInfoMap.put("forced_delay_flag", "");
        // 微信直连配置对象
        // extendInfoMap.put("wx_zl_conf", get75c2df71E09f480bA3eeBe0f014a2f4f());
        // 支付宝直连配置对象
        // extendInfoMap.put("ali_zl_conf", get4e8ae557137348318a1a0b4d4ba06ced());
        // 开户费用值(元)
        ...
        // 分账配置信息
        // extendInfoMap.put("split_conf_info", getDb3fabee680f45c693000b41e47e8d9e());
        // 银联线上收银台
        // extendInfoMap.put("uni_app_payment_config", get5854f22aD2bf4ee8967b9f4a75fc4726());
        // 资金归集开通标记
        // extendInfoMap.put("fund_collection_flag", "");
        // 代发配置
        // extendInfoMap.put("surrogate_config_list", get22f53ed0F93442e38efd8bb2534ae822());
        // 大额支付配置
        // extendInfoMap.put("large_amt_pay_config", getDb5b6a77Db58414589a3701e6fb573d0());
        // 统一收银台开关
        // extendInfoMap.put("half_pay_host_flag", "");
        // 代发复核配置
        // extendInfoMap.put("agent_recheck_config", get82938637A4434631Adb533f0bf8df7d5());
        // 商户开通网银充值开关
        // extendInfoMap.put("online_recharge_flag", "");
        // 是否开通垫资退款
        // extendInfoMap.put("refund_mend_open_flag", "");
        // 捷行付配置
        // extendInfoMap.put("jxf_conf_info", get9dcb72cfB91e4aa4Ac9fE80d1ffc2e5c());
        // 合单支付配置信息
        // extendInfoMap.put("merge_pay_config_info", get372b78a241f840eeA8a03533b54c7714());
        // 是否开通账单支付
    ...
    private static String get22bd128802024820B0c3A1d120b9a9a6() {
    ...
    private static String get1022d935945b49b289345deacaf1ce83() {
        JSONObject dto = new JSONObject();
        // 业务类型
    ...
    private static String getFee4e6746c634ce0B260Dabb0327cf09() {
        JSONObject dto = new JSONObject();
        // 联系人身份证号码
    ...
    private static String get933d58d54e314c2d8a36E0901ed6015a() {
        JSONObject dto = new JSONObject();
        // 证件持有人类型
        // dto.put("legal_type", "");
        // 证件类型
    ...
    private static String getCebc1278880841c2B834Eaee8760d8a0() {
        JSONObject dto = new JSONObject();
        // 是否金融机构
        ...
        // 联系人信息对象
        // dto.put("contact_person_info", getFee4e6746c634ce0B260Dabb0327cf09());
        // 法人身份信息
        // dto.put("legal_person_info", get933d58d54e314c2d8a36E0901ed6015a());

        return dto.toJSONString();
    }

    private static String get8cfab2faCfe44ae0B21a794e75bd4bd8() {
        JSONObject dto = new JSONObject();
        // 手续费（%）
        ...
        // 实名认证信息
        // dto.put("al_real_name_info", getCebc1278880841c2B834Eaee8760d8a0());
    ...
    private static JSON get65063adf1256418f89d539313de35772() {
        JSONObject dto = new JSONObject();
    ...
    private static String get5d5a576915a445fdB6a4201f194bf3e1() {
        JSONObject dto = new JSONObject();
        // 开关状态
        // dto.put("switch_state", "test");
        // 手续费（%）
        ...
        // dto.put("is_check_real_name", "");
        // 实名认证信息
        // dto.put("wx_real_name_info", get65063adf1256418f89d539313de35772());
    ...
    private static String getDaaf08c0F62444fb91552a567b0c9ace() {
        JSONObject dto = new JSONObject();
        // 借记卡手续费（%）
    ...
    private static String getCf413b0e29154766Ac1aEbe329257692() {
        JSONObject dto = new JSONObject();
        // 借记卡手续费（%）
    ...
    private static JSON get5f954791361b4b25B3558ef9aef11da2() {
        JSONObject dto = new JSONObject();
    ...
    private static String get5143e4b430fc47908ac1C2d209773271() {
        JSONObject dto = new JSONObject();
        // *业务模式*
        // dto.put("balance_model", "test");
        // *业务情况说明*
        // dto.put("description_info", get5f954791361b4b25B3558ef9aef11da2());
        // 支付手续费(%)
        dto.put("fee_rate", "2");
        // 支付固定手续费(元)
    ...
    private static String getE0fa63b7868e407dBa7c6da7f4603794() {
        JSONObject dto = new JSONObject();
        // 功能开关
    ...
    private static String getB57b637081014a34A512Bb04f895746e() {
        JSONObject dto = new JSONObject();
        // 业务类型
        // dto.put("pay_type", "");
        // 交易手续费外扣时的账户类型
    ...
    private static JSON getDf1e073e5aed415987928ad39ae355cf() {
        JSONObject dto = new JSONObject();
        // 结算账户名
    ...
    private static JSON getC31b9461Aab242d9Bf4a9136142db217() {
        JSONObject dto = new JSONObject();
        // 开户手续费(元)
    ...
    private static String get9f4ff903Cbec412f9536Dd84c72974d8() {
        JSONObject dto = new JSONObject();
        // 功能开关
        // dto.put("switch_state", "test");
        // 自动入账开关
        ...
        // dto.put("out_fee_huifuid", "");
        // 全域资金开户使用的银行卡信息
        // dto.put("out_order_acct_card", getDf1e073e5aed415987928ad39ae355cf());
        // 全域资金开户手续费
        // dto.put("out_order_acct_open_fees", getC31b9461Aab242d9Bf4a9136142db217());
        // 全域支付业务模式
    ...
    private static String get2cc315bbF4dd4348B2f870c88adf936c() {
        JSONObject dto = new JSONObject();
        // 归集留存金(元)
    ...
    private static String get24eee2eb4b1742b2B5d0Ea330c78abd8() {
        JSONObject dto = new JSONObject();
        // *运营媒介类型*
    ...
    private static String getA9f8b51867f3429181a33dc1de9b9010() {
        JSONObject dto = new JSONObject();
        // *文件id*
    ...
    private static String get6b8226bb9c114949B4a5Face3a7ffc9b() {
        JSONObject dto = new JSONObject();
        // 签约人类型
        // dto.put("type", "test");
    ...
    private static JSON get6cbb0b120f60447491e6F9c2274305e5() {
        JSONObject dto = new JSONObject();
        // 文件类型
    ...
    private static JSON get91a9a2cd686449739e77031e2e532f43() {
        JSONObject dto = new JSONObject();
        // 联系人类型
        ...
        // dto.put("contact_file_list", get6cbb0b120f60447491e6F9c2274305e5());
        // 证件有效期类型
    ...
    private static JSON get1f5d31d6834541cb9628169cf1e41f8c() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static JSON getCadb3862Dee148c29b02C277c49fca9a() {
        JSONObject dto = new JSONObject();
        // 登记证书类型
        // dto.put("cert_type", "test");
        // 证书号
        ...
        // dto.put("cert_begin_date", "test");
        // 文件列表
        // dto.put("cert_file_list", get1f5d31d6834541cb9628169cf1e41f8c());
        // 证书有效期截止日期
    ...
    private static JSON get318978a6E4654fd3B38eF819abc10109() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static JSON get6cc66caa3803443e9be8B9a31c424605() {
        JSONObject dto = new JSONObject();
        // 证件类型
        ...
        // 文件列表
        // dto.put("ubo_file_list", get318978a6E4654fd3B38eF819abc10109());
        // 证件有效期截止日期
    ...
    private static JSON get8dfd7c30C28341349cb67751bade822d() {
        JSONObject dto = new JSONObject();
        // 经营者/法人是否为受益人
        // dto.put("ubo_type", "test");
        // 受益人信息列表jsonArray格式,当ubo_type为Y时可不填
        // dto.put("ubo_info_list", get6cc66caa3803443e9be8B9a31c424605());

        return dto;
    }

    private static JSON get933876be1f2c4b7f8d1b952d6223d68d() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static JSON get32fc68bd22ff40c18cb0855ed55380fc() {
        JSONObject dto = new JSONObject();
        // 经营场景类型
        ...
        // 文件列表
        // dto.put("sales_scenes_file_list", get933876be1f2c4b7f8d1b952d6223d68d());
        // 文件列表
    ...
    private static JSON get2c8fabb11163450b83f911a29a2fa76d() {
        JSONObject dto = new JSONObject();
        // 账户类型
        // dto.put("card_type", "test");
        // 开户名称
    ...
    private static JSON getC8441335Db32415288c065d0233bf196() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static JSON getF080673c80ec4c81B8dd1f176e8f44ea() {
        JSONObject dto = new JSONObject();
        // 申请服务
        ...
        // dto.put("contact_info", get91a9a2cd686449739e77031e2e532f43());
        // 特殊主体登记证书jsonObject字符串，商户营业执照类型为政府机关/事业单位/其他组织时，传入相应信息。新增时需填入
        // dto.put("certificate_info", getCadb3862Dee148c29b02C277c49fca9a());
        // 最终受益人信息jsonObject字符串，商户类型为企业时，微信侧必填。（如果基本信息里有的话，可以不传取 huifu_id 对应的信息）。新增时填入
        // dto.put("ubo_info", get8dfd7c30C28341349cb67751bade822d());
        // 经营场景jsonObject字符串，新增时填入
        // dto.put("sales_info", get32fc68bd22ff40c18cb0855ed55380fc());
        // 银行账户信息jsonObject字符串，该字段不填时，取商户在汇付系统录入的结算账号信息。新增或修改时填入，修改时必填
        // dto.put("wx_card_info", get2c8fabb11163450b83f911a29a2fa76d());
        // 补充说明信息
        // dto.put("business_addition_msg", "");
        // 补充说明文件列表
        // dto.put("addition_file_list", getC8441335Db32415288c065d0233bf196());
    ...
    private static String get75c2df71E09f480bA3eeBe0f014a2f4f() {
        JSONObject dto = new JSONObject();
        // 微信子商户号
        // dto.put("sub_mch_id", "test");
        // 配置集合
        // dto.put("wx_zl_pay_conf_list", getF080673c80ec4c81B8dd1f176e8f44ea());

        return dto.toJSONString();
    }

    private static JSON get85b8a734C9a947fbB86884f09d6a2af8() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static String get4e8ae557137348318a1a0b4d4ba06ced() {
        JSONObject dto = new JSONObject();
        // 申请类型
        ...
        // dto.put("fee_rate", "test");
        // 文件列表
        // dto.put("file_list", get85b8a734C9a947fbB86884f09d6a2af8());
        // 联系人姓名
    ...
    private static JSON get8d9486cc9d18485598b31c67fa48783f() {
        JSONObject dto = new JSONObject();
        // 分账比例
        // dto.put("fee_rate", "test");
        // 汇付Id
    ...
    private static JSON getE69be58785f642a5Aaaf4a9be72698c7() {
        JSONObject dto = new JSONObject();
        // *业务模式说明*
        // dto.put("busi_instruction", "test");
        // *资金流向说明*
    ...
    private static String getDb3fabee680f45c693000b41e47e8d9e() {
        JSONObject dto = new JSONObject();
        // 分账规则来源
        ...
        // dto.put("scene", "test");
        // 分账明细
        // dto.put("acct_split_bunch_list", get8d9486cc9d18485598b31c67fa48783f());
        // 交易手续费外扣开关
        // dto.put("out_fee_flag", "");
        // 交易手续费外扣时的账户类型
        // dto.put("out_fee_acct_type", "");
        ...
        // dto.put("per_amt", "");
        // 业务情况说明
        // dto.put("split_ext_info", getE69be58785f642a5Aaaf4a9be72698c7());

        return dto.toJSONString();
    }

    private static String get5854f22aD2bf4ee8967b9f4a75fc4726() {
        JSONObject dto = new JSONObject();
    ...
    private static String get22f53ed0F93442e38efd8bb2534ae822() {
        JSONObject dto = new JSONObject();
        // 代发业务类型
    ...
    private static JSON get5c727e708f6f458eAbe11ba17354287d() {
        JSONObject dto = new JSONObject();
        // 大额支付业务模式
    ...
    private static String getDb5b6a77Db58414589a3701e6fb573d0() {
        JSONObject dto = new JSONObject();
        // 大额支付配置列表
        // dto.put("large_amt_pay_config_info_list", get5c727e708f6f458eAbe11ba17354287d());
    ...
    private static JSON get82938637A4434631Adb533f0bf8df7d5() {
        JSONObject dto = new JSONObject();
        // 代发复核开关
    ...
    private static JSON getC3b713aa0e7e46da8db441cf0a707738() {
        JSONObject dto = new JSONObject();
        // 操作人姓名
    ...
    private static JSON get9dcb72cfB91e4aa4Ac9fE80d1ffc2e5c() {
        JSONObject dto = new JSONObject();
        // 账户类型
        ...
        // 银行账户信息当账户类型为银行账户时必填
        // dto.put("jxf_bank_info", getC3b713aa0e7e46da8db441cf0a707738());

        return dto;
    }

    private static JSON getA5d36e87F2eb4fefB5bbF51c0dd989d0() {
        JSONObject dto = new JSONObject();
        // 合单支付模式
    ...
    private static JSON get372b78a241f840eeA8a03533b54c7714() {
        JSONObject dto = new JSONObject();
        // 合单支付开关
        // dto.put("merge_pay_flag", "test");
        // 合单支付配置合单支付配置 （当合单支付开关为开时必填）
        // dto.put("merge_pay_config", getA5d36e87F2eb4fefB5bbF51c0dd989d0());
