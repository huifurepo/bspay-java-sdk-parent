...
public class V2MerchantBusiOpenRequestDemo extends BaseCommonDemo {
    ...
    private static Map<String, Object> getExtendInfos() {
        ...
        // 支付宝配置对象
        extendInfoMap.put("ali_conf_list", get026ac522Fa4c4f0b9a9e25bf5fa2820a());
        // 支付宝直连配置对象
        // extendInfoMap.put("ali_zl_conf", get424bc4a40a3040c5A616Cd56826a8440());
        // 开通支付宝预授权
        extendInfoMap.put("alipay_pre_auth_flag", "N");
        // 微信配置对象
        extendInfoMap.put("wx_conf_list", get4d02f8852ccb49b78ee01781c71a6398());
        // 微信直连配置对象
        // extendInfoMap.put("wx_zl_conf", get6824afe4Bddc4c4d95d33b449134f338());
        // 开通微信预授权
        extendInfoMap.put("wechatpay_pre_auth_flag", "N");
        // 银联二维码配置
        extendInfoMap.put("union_conf_list", get69bc2d4563fb43ffB98017ec1008f215());
        // 银行卡业务配置
        extendInfoMap.put("bank_card_conf", get37df90c591a04b5bAeacB366915dd5d6());
        // 线上费率配置
        // extendInfoMap.put("online_fee_conf_list", get4105d915Af1541ccA1507cdbab7d357a());
        // 线上手续费承担方配置
        // extendInfoMap.put("online_pay_fee_conf_list", get6cb7c42aF0974248Ad781b582d94a244());
        // 运营媒介
        // extendInfoMap.put("online_media_info_list", get290a5b7f03bf457cBd2248fe418fd635());
        // *余额支付配置*
        extendInfoMap.put("balance_pay_config", getD1f7e93dE13f4a7c95606a3351e27495());
        // 全域资金管理配置(华通银行)
        // extendInfoMap.put("out_order_funds_config", getEceaa0a102e34914Bacb8a508af7490d());
        // 补贴支付
        extendInfoMap.put("combine_pay_config", get6afda0e343eb445084d53beb9b412155());
        // 花呗分期费率配置
        extendInfoMap.put("hb_fq_fee_config", getC04cb1551c8b46af92c763fcbccc57d7());
        // 汇总结算配置
        // extendInfoMap.put("collection_settle_config_list", get4da99e7aEbcb440bBea89b59b6c674cd());
        // 分账配置信息
        // extendInfoMap.put("split_conf_info", get46961f1a9e9a42118392Fb9f7e40aa5b());
        // 延迟入账开关
        ...
        // *补充文件信息*
        // extendInfoMap.put("extended_material_list", get909c999bA8b445c090b0Fae3c116d120());
        // 开户费用值(元)
        ...
        // 银联线上收银台
        // extendInfoMap.put("uni_app_payment_config", getE9f685328fb04489A3e7Dd05d5968fbc());
        // 资金归集开通标记
        // extendInfoMap.put("fund_collection_flag", "");
        // 代发配置
        // extendInfoMap.put("surrogate_config_list", get2878523a800b431888cf72100e6832b4());
        // 大额支付配置
        // extendInfoMap.put("large_amt_pay_config", getD8688c6a434c4bba871bBe342fd472fb());
        // 托管支付开关
        // extendInfoMap.put("half_pay_host_flag", "");
        // 代发复核配置
        // extendInfoMap.put("agent_recheck_config", get14e9b15dEbb744e8B5a40f9eeac0956b());
        // 商户开通网银充值开关
    ...
    private static JSON get84b9831bE4b046ddA580310b1c8a1b10() {
        JSONObject dto = new JSONObject();
        // 是否金融机构
        ...
        // 联系人信息对象
        // dto.put("contact_person_info", get9f6204410b5d45e081915eef41bc6afe());
        // 法人身份信息
        // dto.put("legal_person_info", get653f8de2Aedb4fb7Af2653d6c2451458());
    ...
    private static String get026ac522Fa4c4f0b9a9e25bf5fa2820a() {
        ...
        // 实名认证信息
        // dto.put("al_real_name_info", get84b9831bE4b046ddA580310b1c8a1b10());
        // *商户经营类目*
    ...
    private static JSON getB49086fc2ba14fc692f3688c87cd19cb() {
        JSONObject dto = new JSONObject();
        // 文件类型
    ...
    private static String get424bc4a40a3040c5A616Cd56826a8440() {
        ...
        // 文件列表
        // dto.put("file_list", getB49086fc2ba14fc692f3688c87cd19cb());
        // 联系人姓名
    ...
    private static JSON get373deb55F5c848589733154152547e94() {
        JSONObject dto = new JSONObject();
    ...
    private static String get4d02f8852ccb49b78ee01781c71a6398() {
        ...
        // dto.put("is_check_real_name", "");
        // 实名认证信息
        // dto.put("wx_real_name_info", get373deb55F5c848589733154152547e94());
    ...
    private static JSON getBa0f2bddDe924aa3A226C0a8bf37ac03() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static JSON get43dcb3051c174e2999aa958d333d51a9() {
        JSONObject dto = new JSONObject();
        // 联系人类型
        ...
        // dto.put("contact_file_list", getBa0f2bddDe924aa3A226C0a8bf37ac03());
        // 证件有效期类型
    ...
    private static JSON getDe30fdcf93e2449fB12cE20592d40152() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static JSON getE88ec054F52e453b99b780005a2cca55() {
        JSONObject dto = new JSONObject();
        // 证件类型
        ...
        // 文件列表
        // dto.put("ubo_file_list", getDe30fdcf93e2449fB12cE20592d40152());
        // 证件有效期截止日期
    ...
    private static JSON getCf74e165F2614313Ba9cE432e65f9b8a() {
        JSONObject dto = new JSONObject();
        // 经营者/法人是否为受益人
        // dto.put("ubo_type", "test");
        // 受益人信息列表jsonArray格式,当ubo_type为Y时可不填
        // dto.put("ubo_info_list", getE88ec054F52e453b99b780005a2cca55());

        return dto;
    }

    private static JSON get2ca59939262440c3B95d30b13061551a() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static JSON get4f537eab57aa43a1A211Fd518bfbde14() {
        JSONObject dto = new JSONObject();
        // 经营场景类型
        ...
        // 文件列表
        // dto.put("sales_scenes_file_list", get2ca59939262440c3B95d30b13061551a());
        // 文件列表
    ...
    private static JSON get6c7be5e681f74f079b9e371f16aaeeb6() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static JSON get08b7aa24911b4296Ad777a6d8ca03637() {
        JSONObject dto = new JSONObject();
        // 登记证书类型
        // dto.put("cert_type", "test");
        // 证书号
        ...
        // 文件列表
        // dto.put("cert_file_list", get6c7be5e681f74f079b9e371f16aaeeb6());
        // 证书有效期截止日期
    ...
    private static JSON get091e205f225e4feb93d18e4844e0d0d9() {
        JSONObject dto = new JSONObject();
        // 账户类型
    ...
    private static JSON get2e683fc56d19440fB29a4f59c8ae9377() {
        JSONObject dto = new JSONObject();
        // 申请服务
    ...
    private static JSON get67c27283754b40568116F25f935a8217() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static String get6824afe4Bddc4c4d95d33b449134f338() {
        ...
        // dto.put("contact_info", get43dcb3051c174e2999aa958d333d51a9());
        // 最终受益人信息jsonObject字符串，商户类型为企业时，微信侧必填。（如果基本信息里有的话，可以不传取 huifu_id 对应的信息）。新增时填入
        // dto.put("ubo_info", getCf74e165F2614313Ba9cE432e65f9b8a());
        // 经营场景jsonObject字符串，新增时填入
        // dto.put("sales_info", get4f537eab57aa43a1A211Fd518bfbde14());
        // 特殊主体登记证书jsonObject字符串，商户营业执照类型为政府机关/事业单位/其他组织时，传入相应信息。新增时需填入
        // dto.put("certificate_info", get08b7aa24911b4296Ad777a6d8ca03637());
        // 银行账户信息jsonObject字符串，该字段不填时，取商户在汇付系统录入的结算账号信息。新增或修改时填入，修改时必填
        // dto.put("wx_card_info", get091e205f225e4feb93d18e4844e0d0d9());
        // 配置集合对指定的sub_mch_id做配置
        // dto.put("wx_zl_pay_conf_list", get2e683fc56d19440fB29a4f59c8ae9377());
        // 操作类型ADD-新增， UPDATE-修改， 默认新增；&lt;font color&#x3D;&quot;green&quot;&gt;示例值：ADD&lt;/font&gt;
        // dto.put("operate_type", "test");
        // 补充说明信息
        // dto.put("business_addition_msg", "");
        // 补充说明文件列表
        // dto.put("addition_file_list", get67c27283754b40568116F25f935a8217());
    ...
    private static JSON getA25edecf2c0c417eB7293e08371e98ee() {
        JSONObject dto = new JSONObject();
        // *业务模式说明*
    ...
    private static String getD1f7e93dE13f4a7c95606a3351e27495() {
        ...
        // 业务情况说明
        // dto.put("description_info", getA25edecf2c0c417eB7293e08371e98ee());
        // 手续费(%)
        dto.put("fee_rate", "2");
        // 手续费（固定/元）
    ...
    private static JSON get0c19544e03c04d5e93d028d1eb74a598() {
        JSONObject dto = new JSONObject();
    ...
    private static JSON get7b034ae2Db4c4b4692df81aecaf2d087() {
        JSONObject dto = new JSONObject();
        // 开户手续费(元)
    ...
    private static String getEceaa0a102e34914Bacb8a508af7490d() {
        ...
        // dto.put("out_fee_huifuid", "");
        // 全域资金开户银行卡信息
        // dto.put("out_order_acct_card", get0c19544e03c04d5e93d028d1eb74a598());
        // 全域资金开户手续费
        // dto.put("out_order_acct_open_fees", get7b034ae2Db4c4b4692df81aecaf2d087());
        // 全域支付业务模式
    ...
    private static JSON get049934de471448939df3Cb2e02e6a1e9() {
        JSONObject dto = new JSONObject();
        // 分账比例
        // dto.put("fee_rate", "test");
        // 汇付Id
    ...
    private static JSON getBa3ca0c5B373417f842d662948a6753d() {
        JSONObject dto = new JSONObject();
        // *业务模式说明*
        // dto.put("busi_instruction", "test");
        // *资金流向说明*
    ...
    private static String get46961f1a9e9a42118392Fb9f7e40aa5b() {
        ...
        // dto.put("scene", "test");
        // 分账明细
        // dto.put("acct_split_bunch_list", get049934de471448939df3Cb2e02e6a1e9());
        // 手续费外扣开关
        // dto.put("out_fee_flag", "");
        // 手续费外扣时的账户类型
        // dto.put("out_fee_acct_type", "");
        ...
        // dto.put("per_amt", "");
        // 业务情况说明
        // dto.put("split_ext_info", getBa3ca0c5B373417f842d662948a6753d());
    ...
    private static JSON get01b9a639116b497f8c9863d7142a7348() {
        JSONObject dto = new JSONObject();
        // 大额支付业务模式
    ...
    private static String getD8688c6a434c4bba871bBe342fd472fb() {
        JSONObject dto = new JSONObject();
        // 大额支付配置列表
        // dto.put("large_amt_pay_config_info_list", get01b9a639116b497f8c9863d7142a7348());
    ...
    private static JSON get14e9b15dEbb744e8B5a40f9eeac0956b() {
        JSONObject dto = new JSONObject();
        // 代发复核开关
