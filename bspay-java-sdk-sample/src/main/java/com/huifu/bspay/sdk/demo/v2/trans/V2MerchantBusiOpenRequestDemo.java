...
public class V2MerchantBusiOpenRequestDemo extends BaseCommonDemo {
    ...
    private static Map<String, Object> getExtendInfos() {
        ...
        // 支付宝配置对象
        extendInfoMap.put("ali_conf_list", get478799cd11084bc08ed485f3a249ca6a());
        // 支付宝直连配置对象
        // extendInfoMap.put("ali_zl_conf", get634ed7c84eca4ad0Bb8421c67e824303());
        // 开通支付宝预授权
        extendInfoMap.put("alipay_pre_auth_flag", "N");
        // 微信配置对象
        extendInfoMap.put("wx_conf_list", get09f8037593ee4eac9570Ba9ddc1612ad());
        // 微信直连配置对象
        // extendInfoMap.put("wx_zl_conf", get319b652307344ce79d45307f2d114a68());
        // 开通微信预授权
        extendInfoMap.put("wechatpay_pre_auth_flag", "N");
        // 银联二维码配置
        extendInfoMap.put("union_conf_list", get60616eb26e03439f81239fb8318ed62f());
        // 银行卡业务配置
        extendInfoMap.put("bank_card_conf", getDeea5d3d4d29471bB7b29439f1d0e07f());
        // 线上费率配置
        // extendInfoMap.put("online_fee_conf_list", get2bc56ce2B064446fA95a9832dad239f0());
        // 线上手续费承担方配置
        // extendInfoMap.put("online_pay_fee_conf_list", get3b35e04908e947e78769A1e5f2f0ed74());
        // 运营媒介
        // extendInfoMap.put("online_media_info_list", getFa5274c3A5ea48f6A5467a586e8ea582());
        // *余额支付配置*
        extendInfoMap.put("balance_pay_config", getF56330e7Fc644efbB753F7b0f8a9b6e1());
        // 全域资金管理配置(华通银行)
        // extendInfoMap.put("out_order_funds_config", getEab35e389c13461fA6edAc767aed351b());
        // 补贴支付
        extendInfoMap.put("combine_pay_config", getA9f5c1e22a994d8f90206da940897690());
        // 花呗分期费率配置
        extendInfoMap.put("hb_fq_fee_config", get1ad8faaeE63645969b3413b8681e4638());
        // 分账配置信息
        // extendInfoMap.put("split_conf_info", getEfbd03dfC75a4afa8ac76f4d0f398331());
        // 延迟入账开关
        ...
        // *补充文件信息*
        // extendInfoMap.put("extended_material_list", getAef40e3c790348dbB940468f1aabc693());
        // 开户费用值(元)
        ...
        // 银联线上收银台
        // extendInfoMap.put("uni_app_payment_config", get0e8626b0D6ff4e189d0b94738e302de9());
        // 资金归集开通标记
        // extendInfoMap.put("fund_collection_flag", "");
        // 代发配置
        // extendInfoMap.put("surrogate_config_list", get813386b7B20640ebBf098997c6ed1cf3());
        // 大额支付配置
        // extendInfoMap.put("large_amt_pay_config", get323ec72fF7404f0fA5c50ecc9d190984());
        // 统一收银台开关
        // extendInfoMap.put("half_pay_host_flag", "");
        // 代发复核配置
        // extendInfoMap.put("agent_recheck_config", get3b97fbcbC6de4a4c9e68Eed1e77df906());
        // 商户开通网银充值开关
        // extendInfoMap.put("online_recharge_flag", "");
        // 是否开通垫资退款
        // extendInfoMap.put("refund_mend_open_flag", "");
        // 捷行付配置
        // extendInfoMap.put("jxf_conf_info", getCe1839a2C3ac42bf9cef719131bec63f());
        // 合单支付配置信息
        // extendInfoMap.put("merge_pay_config_info", get1a36010d242b46c3B1ea818fca738eed());
        // 是否开通账单支付
    ...
    private static String get2a2149bfAf854643B51c7f1b9da01424() {
    ...
    private static String getDc710134049547279fb86ddf6e01a8b4() {
        JSONObject dto = new JSONObject();
        // 联系人身份证号码
    ...
    private static String getA08df1f978214d45880bA4689292cd7b() {
        JSONObject dto = new JSONObject();
        // 证件持有人类型
        // dto.put("legal_type", "");
        // 证件类型
    ...
    private static JSON getD7503dc89d9142b388787e0fa8d34b96() {
        JSONObject dto = new JSONObject();
        // 是否金融机构
        ...
        // 联系人信息对象
        // dto.put("contact_person_info", getDc710134049547279fb86ddf6e01a8b4());
        // 法人身份信息
        // dto.put("legal_person_info", getA08df1f978214d45880bA4689292cd7b());

        return dto;
    }

    private static String get478799cd11084bc08ed485f3a249ca6a() {
        JSONObject dto = new JSONObject();
        // 支付场景
        dto.put("pay_scene", "1");
        // 手续费（%）
        ...
        // 实名认证信息
        // dto.put("al_real_name_info", getD7503dc89d9142b388787e0fa8d34b96());
        // *商户经营类目*
    ...
    private static JSON get58acf53807e44c16B72605774e47900b() {
        JSONObject dto = new JSONObject();
        // 文件类型
    ...
    private static String get634ed7c84eca4ad0Bb8421c67e824303() {
        JSONObject dto = new JSONObject();
        // 申请类型
        ...
        // 文件列表
        // dto.put("file_list", get58acf53807e44c16B72605774e47900b());
        // 联系人姓名
    ...
    private static JSON get36c6da20338643bbBa7c2f31aa510aff() {
        JSONObject dto = new JSONObject();
    ...
    private static String get09f8037593ee4eac9570Ba9ddc1612ad() {
        JSONObject dto = new JSONObject();
        // 支付场景
        dto.put("pay_scene", "1");
        // 手续费（%）
        ...
        // dto.put("is_check_real_name", "");
        // 实名认证信息
        // dto.put("wx_real_name_info", get36c6da20338643bbBa7c2f31aa510aff());
    ...
    private static JSON get320f0de00b3b4710825559b061567546() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static JSON get78f624039b2449b38d76E5508f04c84b() {
        JSONObject dto = new JSONObject();
        // 联系人类型
        ...
        // dto.put("contact_file_list", get320f0de00b3b4710825559b061567546());
        // 证件有效期类型
    ...
    private static JSON getEd2ea2f2A51b42e3842497f1ae54b8f3() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static JSON get0b0fe85fCdad4e49B992Cbfa72fbf901() {
        JSONObject dto = new JSONObject();
        // 证件类型
        ...
        // 文件列表
        // dto.put("ubo_file_list", getEd2ea2f2A51b42e3842497f1ae54b8f3());
        // 证件有效期截止日期
    ...
    private static JSON get64dfc222C69047f5A10e7eab12dc12e1() {
        JSONObject dto = new JSONObject();
        // 经营者/法人是否为受益人
        // dto.put("ubo_type", "test");
        // 受益人信息列表jsonArray格式,当ubo_type为Y时可不填
        // dto.put("ubo_info_list", get0b0fe85fCdad4e49B992Cbfa72fbf901());

        return dto;
    }

    private static JSON get6f12a4f38ce74bd39b80B3a95031b563() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static JSON getC45fb266083a4a3fB1225dd52b1dbcfc() {
        JSONObject dto = new JSONObject();
        // 经营场景类型
        ...
        // 文件列表
        // dto.put("sales_scenes_file_list", get6f12a4f38ce74bd39b80B3a95031b563());
        // 文件列表
    ...
    private static JSON getE67eebf9E29847ce8ff76640f4321a74() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static JSON getF58e55d153ae4670889324133cde20cc() {
        JSONObject dto = new JSONObject();
        // 登记证书类型
        // dto.put("cert_type", "test");
        // 证书号
        ...
        // 文件列表
        // dto.put("cert_file_list", getE67eebf9E29847ce8ff76640f4321a74());
        // 证书有效期截止日期
    ...
    private static JSON get8f45ecc572224de89d24B33c95e03414() {
        JSONObject dto = new JSONObject();
        // 账户类型
    ...
    private static JSON getF62fbb8f44914cbd96afE8f2c9dd0412() {
        JSONObject dto = new JSONObject();
        // 申请服务
    ...
    private static JSON get2844bc2687cf4686A0e49a1f80be81c3() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static String get319b652307344ce79d45307f2d114a68() {
        JSONObject dto = new JSONObject();
        // 微信子商户号微信支付分配的子商户号；&lt;font color&#x3D;&quot;green&quot;&gt;示例值：1632157057&lt;/font&gt;
        // dto.put("sub_mch_id", "test");
        // 联系人信息jsonObject字符串,新增时必填
        // dto.put("contact_info", get78f624039b2449b38d76E5508f04c84b());
        // 最终受益人信息jsonObject字符串，商户类型为企业时，微信侧必填。（如果基本信息里有的话，可以不传取 huifu_id 对应的信息）。新增时填入
        // dto.put("ubo_info", get64dfc222C69047f5A10e7eab12dc12e1());
        // 经营场景jsonObject字符串，新增时填入
        // dto.put("sales_info", getC45fb266083a4a3fB1225dd52b1dbcfc());
        // 特殊主体登记证书jsonObject字符串，商户营业执照类型为政府机关/事业单位/其他组织时，传入相应信息。新增时需填入
        // dto.put("certificate_info", getF58e55d153ae4670889324133cde20cc());
        // 银行账户信息jsonObject字符串，该字段不填时，取商户在汇付系统录入的结算账号信息。新增或修改时填入，修改时必填
        // dto.put("wx_card_info", get8f45ecc572224de89d24B33c95e03414());
        // 配置集合对指定的sub_mch_id做配置
        // dto.put("wx_zl_pay_conf_list", getF62fbb8f44914cbd96afE8f2c9dd0412());
        // 操作类型ADD-新增， UPDATE-修改， 默认新增；&lt;font color&#x3D;&quot;green&quot;&gt;示例值：ADD&lt;/font&gt;
        // dto.put("operate_type", "test");
        // 补充说明信息
        // dto.put("business_addition_msg", "");
        // 补充说明文件列表
        // dto.put("addition_file_list", get2844bc2687cf4686A0e49a1f80be81c3());

        return dto.toJSONString();
    }

    private static String get60616eb26e03439f81239fb8318ed62f() {
        JSONObject dto = new JSONObject();
        // 借记卡手续费（%）
    ...
    private static String getDeea5d3d4d29471bB7b29439f1d0e07f() {
        JSONObject dto = new JSONObject();
        // 借记卡手续费（%）
    ...
    private static String get2bc56ce2B064446fA95a9832dad239f0() {
        JSONObject dto = new JSONObject();
        // 业务类型
    ...
    private static String get3b35e04908e947e78769A1e5f2f0ed74() {
        JSONObject dto = new JSONObject();
        // 业务类型
        // dto.put("pay_type", "");
        // 手续费外扣时的账户类型
    ...
    private static String getFa5274c3A5ea48f6A5467a586e8ea582() {
        JSONObject dto = new JSONObject();
        // *运营媒介类型*
    ...
    private static JSON getA40c082d6276428aB27a6e976fcba2ae() {
        JSONObject dto = new JSONObject();
    ...
    private static String getF56330e7Fc644efbB753F7b0f8a9b6e1() {
        JSONObject dto = new JSONObject();
        // *业务模式*
        // dto.put("balance_model", "test");
        // 业务情况说明
        // dto.put("description_info", getA40c082d6276428aB27a6e976fcba2ae());
        // 手续费(%)
        dto.put("fee_rate", "2");
        // 手续费（固定/元）
    ...
    private static JSON getEe350cc29338400a84451596d904827c() {
        JSONObject dto = new JSONObject();
    ...
    private static JSON get80aebe804e89490d839428fdc8fb94ad() {
        JSONObject dto = new JSONObject();
        // 开户手续费(元)
    ...
    private static String getEab35e389c13461fA6edAc767aed351b() {
        JSONObject dto = new JSONObject();
        // 自动入账开关
        ...
        // dto.put("out_fee_huifuid", "");
        // 全域资金开户银行卡信息
        // dto.put("out_order_acct_card", getEe350cc29338400a84451596d904827c());
        // 全域资金开户手续费
        // dto.put("out_order_acct_open_fees", get80aebe804e89490d839428fdc8fb94ad());
        // 全域支付业务模式
    ...
    private static String getA9f5c1e22a994d8f90206da940897690() {
        JSONObject dto = new JSONObject();
        // 是否交易手续费外扣
    ...
    private static String get1ad8faaeE63645969b3413b8681e4638() {
        JSONObject dto = new JSONObject();
    ...
    private static JSON getBc37c628853c4916Bb305bbe29cf732b() {
        JSONObject dto = new JSONObject();
        // 分账比例
        // dto.put("fee_rate", "test");
        // 汇付Id
    ...
    private static JSON get055625312aef4e4a9519Bd5c7bc551af() {
        JSONObject dto = new JSONObject();
        // *业务模式说明*
        // dto.put("busi_instruction", "test");
        // *资金流向说明*
    ...
    private static String getEfbd03dfC75a4afa8ac76f4d0f398331() {
        JSONObject dto = new JSONObject();
        // 分账开关
        ...
        // dto.put("scene", "test");
        // 分账明细
        // dto.put("acct_split_bunch_list", getBc37c628853c4916Bb305bbe29cf732b());
        // 生效类型
        // dto.put("start_type", "");
        // 手续费外扣开关
        // dto.put("out_fee_flag", "");
        ...
        // dto.put("per_amt", "");
        // 业务情况说明
        // dto.put("split_ext_info", get055625312aef4e4a9519Bd5c7bc551af());

        return dto.toJSONString();
    }

    private static String getAef40e3c790348dbB940468f1aabc693() {
        JSONObject dto = new JSONObject();
        // *文件id*
        // dto.put("file_id", "test");
        // *文件类型*
    ...
    private static String getA0c326fbD2684e10A91fFe6502b671f7() {
        JSONObject dto = new JSONObject();
        // *协议类型*
    ...
    private static String get0e8626b0D6ff4e189d0b94738e302de9() {
        JSONObject dto = new JSONObject();
    ...
    private static String get813386b7B20640ebBf098997c6ed1cf3() {
        JSONObject dto = new JSONObject();
        // 代发业务类型
    ...
    private static JSON get446d884cEc624539A2b8D74916efc7b1() {
        JSONObject dto = new JSONObject();
        // 大额支付业务模式
    ...
    private static String get323ec72fF7404f0fA5c50ecc9d190984() {
        JSONObject dto = new JSONObject();
        // 大额支付配置列表
        // dto.put("large_amt_pay_config_info_list", get446d884cEc624539A2b8D74916efc7b1());
    ...
    private static JSON get3b97fbcbC6de4a4c9e68Eed1e77df906() {
        JSONObject dto = new JSONObject();
        // 代发复核开关
    ...
    private static JSON getD6094c6820ef4f098115Ed78e62302c8() {
        JSONObject dto = new JSONObject();
        // 操作人姓名
    ...
    private static JSON getCe1839a2C3ac42bf9cef719131bec63f() {
        JSONObject dto = new JSONObject();
        // 账户类型
        // dto.put("acct_type", "test");
        // 银行账户信息当账户类型为银行账户时必填
        // dto.put("jxf_bank_info", getD6094c6820ef4f098115Ed78e62302c8());

        return dto;
    }

    private static JSON getF1e27f53D58f46b785d7B759ddd6e3a8() {
        JSONObject dto = new JSONObject();
        // 合单支付模式
    ...
    private static JSON get1a36010d242b46c3B1ea818fca738eed() {
        JSONObject dto = new JSONObject();
        // 合单支付开关
        // dto.put("merge_pay_flag", "test");
        // 合单支付配置合单支付配置 （当合单支付开关为开时必填）
        // dto.put("merge_pay_config", getF1e27f53D58f46b785d7B759ddd6e3a8());
