...
public class V2MerchantBusiOpenRequestDemo extends BaseCommonDemo {
    ...
    private static Map<String, Object> getExtendInfos() {
        ...
        // 支付宝配置对象
        extendInfoMap.put("ali_conf_list", get21fac24742f9427aA460Aab352a6432f());
        // 支付宝直连配置对象
        // extendInfoMap.put("ali_zl_conf", get88a6111e41a844b886b0E6bb77ca1b9c());
        // 开通支付宝预授权
        extendInfoMap.put("alipay_pre_auth_flag", "N");
        // 微信配置对象
        extendInfoMap.put("wx_conf_list", getF3d85b100b98442996569fc23beba46b());
        // 微信直连配置对象
        // extendInfoMap.put("wx_zl_conf", getC7503ea387844077A01a3062082cc013());
        // 开通微信预授权
        extendInfoMap.put("wechatpay_pre_auth_flag", "N");
        // 银联二维码配置
        extendInfoMap.put("union_conf_list", get20f5ad4bF54f4286Bde6Cfcfeb6153bf());
        // 银行卡业务配置
        extendInfoMap.put("bank_card_conf", get77f68bdc3bd147869d4e3b69e935fe88());
        // 线上费率配置
        // extendInfoMap.put("online_fee_conf_list", get94326be6F38f4193925fD4bd3da0fece());
        // 线上手续费承担方配置
        // extendInfoMap.put("online_pay_fee_conf_list", getD449710963124a3690477580031161bf());
        // 运营媒介
        // extendInfoMap.put("online_media_info_list", get1fcfc7baF5d148889917938e9b883f03());
        // *余额支付配置*
        extendInfoMap.put("balance_pay_config", getDc4988554ee74ddfBa3989153611eb1f());
        // 全域资金管理配置(华通银行)
        // extendInfoMap.put("out_order_funds_config", get5bdfdb6508b04408Ae95Cdfaa942d289());
        // 补贴支付
        extendInfoMap.put("combine_pay_config", get2960341b43524ee5B6ac6cdd21c82adc());
        // 花呗分期费率配置
        extendInfoMap.put("hb_fq_fee_config", get7fb3ebc3Bc074f9388f321d6479aa9f1());
        // 汇总结算配置
        // extendInfoMap.put("collection_settle_config_list", get1a5d8b7863b745e4823aF9b1cdf777e8());
        // 分账配置信息
        // extendInfoMap.put("split_conf_info", getC42884ccF1c34024B67f38aaaba20c6d());
        // 延迟入账开关
        ...
        // *补充文件信息*
        // extendInfoMap.put("extended_material_list", get0084765a7bce49e597667ac9645b0212());
        // 开户费用值(元)
        ...
        // 银联线上收银台
        // extendInfoMap.put("uni_app_payment_config", get9aa699174a274895B393A6fadb5d95b8());
        // 资金归集开通标记
        // extendInfoMap.put("fund_collection_flag", "");
        // 代发配置
        // extendInfoMap.put("surrogate_config_list", get68fad2ce1407417fAfecF5d7c76f5c44());
        // 大额支付配置
        // extendInfoMap.put("large_amt_pay_config", get07efeda90f7849fbAcdeBeaa1db4cc83());
        // 托管支付开关
        // extendInfoMap.put("half_pay_host_flag", "");
        // 代发复核配置
        // extendInfoMap.put("agent_recheck_config", getD8249d311f9f42989beeB0c19cc40c96());
        // 商户开通网银充值开关
    ...
    private static String getDaf7f2d752374b63B9433eed93587606() {
    ...
    private static String get3cc9d3a6454340ff8251703bdeb70fcf() {
        JSONObject dto = new JSONObject();
        // 联系人身份证号码
    ...
    private static String get10b3e4a3887c493dA5871786d353f7df() {
        JSONObject dto = new JSONObject();
        // 证件持有人类型
        // dto.put("legal_type", "");
        // 证件类型
    ...
    private static JSON get8a2e5c750608487eA4c742b3a2c56b27() {
        JSONObject dto = new JSONObject();
        // 是否金融机构
        ...
        // 联系人信息对象
        // dto.put("contact_person_info", get3cc9d3a6454340ff8251703bdeb70fcf());
        // 法人身份信息
        // dto.put("legal_person_info", get10b3e4a3887c493dA5871786d353f7df());

        return dto;
    }

    private static String get21fac24742f9427aA460Aab352a6432f() {
        JSONObject dto = new JSONObject();
        // 支付场景
        dto.put("pay_scene", "1");
        // 手续费（%）
        ...
        // 实名认证信息
        // dto.put("al_real_name_info", get8a2e5c750608487eA4c742b3a2c56b27());
        // *商户经营类目*
    ...
    private static JSON getCdd891aa7c744bf999d24c2b165a9beb() {
        JSONObject dto = new JSONObject();
        // 文件类型
    ...
    private static String get88a6111e41a844b886b0E6bb77ca1b9c() {
        JSONObject dto = new JSONObject();
        // 申请类型
        ...
        // 文件列表
        // dto.put("file_list", getCdd891aa7c744bf999d24c2b165a9beb());
        // 联系人姓名
    ...
    private static JSON get41455f58592c46f9825138fcecc83239() {
        JSONObject dto = new JSONObject();
    ...
    private static String getF3d85b100b98442996569fc23beba46b() {
        JSONObject dto = new JSONObject();
        // 支付场景
        dto.put("pay_scene", "1");
        // 手续费（%）
        ...
        // dto.put("is_check_real_name", "");
        // 实名认证信息
        // dto.put("wx_real_name_info", get41455f58592c46f9825138fcecc83239());
    ...
    private static JSON get26ca5760B92c47deBcdf1f965829d45b() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static JSON get6546b55169b14bd68e38051a0cc8dca3() {
        JSONObject dto = new JSONObject();
        // 联系人类型
        ...
        // dto.put("contact_file_list", get26ca5760B92c47deBcdf1f965829d45b());
        // 证件有效期类型
    ...
    private static JSON getA44687d41b8a4cbeBe711d241337aa53() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static JSON getFf3d6e72A6984258B84d4d6180ca124e() {
        JSONObject dto = new JSONObject();
        // 证件类型
        ...
        // 文件列表
        // dto.put("ubo_file_list", getA44687d41b8a4cbeBe711d241337aa53());
        // 证件有效期截止日期
    ...
    private static JSON getAa40331d7c7c4fee8725C040cfc89336() {
        JSONObject dto = new JSONObject();
        // 经营者/法人是否为受益人
        // dto.put("ubo_type", "test");
        // 受益人信息列表jsonArray格式,当ubo_type为Y时可不填
        // dto.put("ubo_info_list", getFf3d6e72A6984258B84d4d6180ca124e());

        return dto;
    }

    private static JSON getA11f01730306436c930fE86b1056b00d() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static JSON get16252679Ad9447e38facD6ccd1673dc5() {
        JSONObject dto = new JSONObject();
        // 经营场景类型
        ...
        // 文件列表
        // dto.put("sales_scenes_file_list", getA11f01730306436c930fE86b1056b00d());
        // 文件列表
    ...
    private static JSON get5bd4f96f1fb343e7A2b8Df1899997462() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static JSON get37990abe9331440eA1f61645c12a9689() {
        JSONObject dto = new JSONObject();
        // 登记证书类型
        // dto.put("cert_type", "test");
        // 证书号
        ...
        // 文件列表
        // dto.put("cert_file_list", get5bd4f96f1fb343e7A2b8Df1899997462());
        // 证书有效期截止日期
    ...
    private static JSON getC23b7a7fE38e4cda8c374aec7044b45b() {
        JSONObject dto = new JSONObject();
        // 账户类型
    ...
    private static JSON get17cfb4fd36b44ef29ce4516af9858c25() {
        JSONObject dto = new JSONObject();
        // 申请服务
    ...
    private static JSON get6ce22e4b07b64c79A87025ba63c99290() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static String getC7503ea387844077A01a3062082cc013() {
        JSONObject dto = new JSONObject();
        // 微信子商户号微信支付分配的子商户号；&lt;font color&#x3D;&quot;green&quot;&gt;示例值：1632157057&lt;/font&gt;
        // dto.put("sub_mch_id", "test");
        // 联系人信息jsonObject字符串,新增时必填
        // dto.put("contact_info", get6546b55169b14bd68e38051a0cc8dca3());
        // 最终受益人信息jsonObject字符串，商户类型为企业时，微信侧必填。（如果基本信息里有的话，可以不传取 huifu_id 对应的信息）。新增时填入
        // dto.put("ubo_info", getAa40331d7c7c4fee8725C040cfc89336());
        // 经营场景jsonObject字符串，新增时填入
        // dto.put("sales_info", get16252679Ad9447e38facD6ccd1673dc5());
        // 特殊主体登记证书jsonObject字符串，商户营业执照类型为政府机关/事业单位/其他组织时，传入相应信息。新增时需填入
        // dto.put("certificate_info", get37990abe9331440eA1f61645c12a9689());
        // 银行账户信息jsonObject字符串，该字段不填时，取商户在汇付系统录入的结算账号信息。新增或修改时填入，修改时必填
        // dto.put("wx_card_info", getC23b7a7fE38e4cda8c374aec7044b45b());
        // 配置集合对指定的sub_mch_id做配置
        // dto.put("wx_zl_pay_conf_list", get17cfb4fd36b44ef29ce4516af9858c25());
        // 操作类型ADD-新增， UPDATE-修改， 默认新增；&lt;font color&#x3D;&quot;green&quot;&gt;示例值：ADD&lt;/font&gt;
        // dto.put("operate_type", "test");
        // 补充说明信息
        // dto.put("business_addition_msg", "");
        // 补充说明文件列表
        // dto.put("addition_file_list", get6ce22e4b07b64c79A87025ba63c99290());

        return dto.toJSONString();
    }

    private static String get20f5ad4bF54f4286Bde6Cfcfeb6153bf() {
        JSONObject dto = new JSONObject();
        // 借记卡手续费（%）
    ...
    private static String get77f68bdc3bd147869d4e3b69e935fe88() {
        JSONObject dto = new JSONObject();
        // 借记卡手续费（%）
    ...
    private static String get94326be6F38f4193925fD4bd3da0fece() {
        JSONObject dto = new JSONObject();
        // 业务类型
    ...
    private static String getD449710963124a3690477580031161bf() {
        JSONObject dto = new JSONObject();
        // 业务类型
        // dto.put("pay_type", "");
        // 手续费外扣时的账户类型
    ...
    private static String get1fcfc7baF5d148889917938e9b883f03() {
        JSONObject dto = new JSONObject();
        // *运营媒介类型*
    ...
    private static JSON getCc41b1adFedb4976B5ad288411eb1ff2() {
        JSONObject dto = new JSONObject();
    ...
    private static String getDc4988554ee74ddfBa3989153611eb1f() {
        JSONObject dto = new JSONObject();
        // *业务模式*
        // dto.put("balance_model", "test");
        // 业务情况说明
        // dto.put("description_info", getCc41b1adFedb4976B5ad288411eb1ff2());
        // 手续费(%)
        dto.put("fee_rate", "2");
        // 手续费（固定/元）
    ...
    private static JSON get362d896dC911494fBba6698ad92cc098() {
        JSONObject dto = new JSONObject();
    ...
    private static JSON getD7f6aec01dd34576B03921d38a1c98e8() {
        JSONObject dto = new JSONObject();
        // 开户手续费(元)
    ...
    private static String get5bdfdb6508b04408Ae95Cdfaa942d289() {
        JSONObject dto = new JSONObject();
        // 自动入账开关
        ...
        // dto.put("out_fee_huifuid", "");
        // 全域资金开户银行卡信息
        // dto.put("out_order_acct_card", get362d896dC911494fBba6698ad92cc098());
        // 全域资金开户手续费
        // dto.put("out_order_acct_open_fees", getD7f6aec01dd34576B03921d38a1c98e8());
        // 全域支付业务模式
    ...
    private static String get2960341b43524ee5B6ac6cdd21c82adc() {
        JSONObject dto = new JSONObject();
        // 是否交易手续费外扣
    ...
    private static String get7fb3ebc3Bc074f9388f321d6479aa9f1() {
        JSONObject dto = new JSONObject();
    ...
    private static String get1a5d8b7863b745e4823aF9b1cdf777e8() {
        JSONObject dto = new JSONObject();
        // 归集留存金(元)
    ...
    private static JSON get918b83c413f74502Ab3fBa415df84980() {
        JSONObject dto = new JSONObject();
        // 分账比例
        // dto.put("fee_rate", "test");
        // 汇付Id
    ...
    private static JSON getDbde2eab1c7a4cde830b2384a4c624a0() {
        JSONObject dto = new JSONObject();
        // *业务模式说明*
        // dto.put("busi_instruction", "test");
        // *资金流向说明*
    ...
    private static String getC42884ccF1c34024B67f38aaaba20c6d() {
        JSONObject dto = new JSONObject();
        // 分账开关
        ...
        // dto.put("scene", "test");
        // 分账明细
        // dto.put("acct_split_bunch_list", get918b83c413f74502Ab3fBa415df84980());
        // 手续费外扣开关
        // dto.put("out_fee_flag", "");
        // 手续费外扣时的账户类型
        // dto.put("out_fee_acct_type", "");
        ...
        // dto.put("per_amt", "");
        // 业务情况说明
        // dto.put("split_ext_info", getDbde2eab1c7a4cde830b2384a4c624a0());

        return dto.toJSONString();
    }

    private static String get0084765a7bce49e597667ac9645b0212() {
        JSONObject dto = new JSONObject();
        // *文件id*
        // dto.put("file_id", "test");
        // *文件类型*
    ...
    private static String get7a451c27Db114cb48ea6145ced19c91c() {
        JSONObject dto = new JSONObject();
        // *协议类型*
    ...
    private static String get9aa699174a274895B393A6fadb5d95b8() {
        JSONObject dto = new JSONObject();
    ...
    private static String get68fad2ce1407417fAfecF5d7c76f5c44() {
        JSONObject dto = new JSONObject();
        // 代发业务类型
    ...
    private static JSON getE30e4f41A98a4b7a9d3c23c655436c06() {
        JSONObject dto = new JSONObject();
        // 大额支付业务模式
    ...
    private static String get07efeda90f7849fbAcdeBeaa1db4cc83() {
        JSONObject dto = new JSONObject();
        // 大额支付配置列表
        // dto.put("large_amt_pay_config_info_list", getE30e4f41A98a4b7a9d3c23c655436c06());
    ...
    private static JSON getD8249d311f9f42989beeB0c19cc40c96() {
        JSONObject dto = new JSONObject();
        // 代发复核开关
