...
public class V2MerchantBusiOpenRequestDemo extends BaseCommonDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // request.setSignUserInfo(getC1c117481a5a4c1dBeea310cbcf91351());
        ...
        request.setAgreementInfo(get7883a6dcA5f74c6eB90eC3fabe13e8e2());
    ...
    private static Map<String, Object> getExtendInfos() {
        ...
        // 支付宝配置对象
        extendInfoMap.put("ali_conf_list", getD712bd9d6eb5416493e1F070fb246763());
        // 支付宝直连配置对象
        // extendInfoMap.put("ali_zl_conf", get5218d02cA2c74ab2Adb57dbebed0cb10());
        // 开通支付宝预授权
        extendInfoMap.put("alipay_pre_auth_flag", "N");
        // 微信配置对象
        extendInfoMap.put("wx_conf_list", getB7a9c72d94054b23A658Bc32683b9ed3());
        // 微信直连配置对象
        // extendInfoMap.put("wx_zl_conf", getBfd8a14f1c2d4465Ab68204aab071c0b());
        // 开通微信预授权
        extendInfoMap.put("wechatpay_pre_auth_flag", "N");
        // 银联二维码配置
        extendInfoMap.put("union_conf_list", get91dc4460855b49d283aeDd5b13718e59());
        // 银行卡业务配置
        extendInfoMap.put("bank_card_conf", get95ffaa148541491a857c1a596057f811());
        // 线上费率配置
        // extendInfoMap.put("online_fee_conf_list", get02bb410b04024cd98bd557b227370b5d());
        // 线上手续费承担方配置
        // extendInfoMap.put("online_pay_fee_conf_list", getD0ea2a0b7f58464d9bd14a5f4ac3b99e());
        // 运营媒介
        // extendInfoMap.put("online_media_info_list", getB90857126d054664855a2f2b7b9577aa());
        // *余额支付配置*
        extendInfoMap.put("balance_pay_config", getC093f60f23ba4738A58bF86aba0d3415());
        // 全域资金管理配置(华通银行)
        // extendInfoMap.put("out_order_funds_config", get2d6a049a386749beB57317d6b4c6d911());
        // 补贴支付
        extendInfoMap.put("combine_pay_config", getBfe028f4B9994c25Ba88669a42cbc40c());
        // 花呗分期费率配置
        extendInfoMap.put("hb_fq_fee_config", get9e6683ad06534579B3415bc19a5be63f());
        // 分账配置信息
        // extendInfoMap.put("split_conf_info", get0b0568820b264abb9bef3e7712e2fbba());
        // 延迟入账开关
        ...
        // *补充文件信息*
        // extendInfoMap.put("extended_material_list", getFea2e375Ad9044b59a001ea1353898dc());
        // 开户费用值(元)
        ...
        // 银联线上收银台
        // extendInfoMap.put("uni_app_payment_config", getA6ba1a0dD14544d7Bd01F8092622f28a());
        // 资金归集开通标记
        // extendInfoMap.put("fund_collection_flag", "");
        // 代发配置
        // extendInfoMap.put("surrogate_config_list", get2a628c2cBc174240B2865e0949dcf96b());
        // 大额支付配置
        // extendInfoMap.put("large_amt_pay_config", getF241a679Acca455189d0E17c3b4709cf());
        // 统一收银台开关
        // extendInfoMap.put("half_pay_host_flag", "");
        // 代发复核配置
        // extendInfoMap.put("agent_recheck_config", getBc43f1ed4e464136B2087c2378dbb444());
        // 商户开通网银充值开关
        // extendInfoMap.put("online_recharge_flag", "");
        // 是否开通垫资退款
        // extendInfoMap.put("refund_mend_open_flag", "");
        // 捷行付配置
        // extendInfoMap.put("jxf_conf_info", get3f9afc9bDf024af89b68380c4daff449());
        // 合单支付配置信息
        // extendInfoMap.put("merge_pay_config_info", get0390e26bFc4d42268f1c0535873e409f());
        // 是否开通账单支付
    ...
    private static String getC1c117481a5a4c1dBeea310cbcf91351() {
    ...
    private static String get67c38553Fea14e1581640a70ad63aaf5() {
        JSONObject dto = new JSONObject();
        // 联系人身份证号码
    ...
    private static String get7c86e52875ab45bd87867358089d0029() {
        JSONObject dto = new JSONObject();
        // 证件持有人类型
        // dto.put("legal_type", "");
        // 证件类型
    ...
    private static JSON getAa5f8b765dd440ceAe025cecebbc7aba() {
        JSONObject dto = new JSONObject();
        // 是否金融机构
        ...
        // 联系人信息对象
        // dto.put("contact_person_info", get67c38553Fea14e1581640a70ad63aaf5());
        // 法人身份信息
        // dto.put("legal_person_info", get7c86e52875ab45bd87867358089d0029());

        return dto;
    }

    private static String getD712bd9d6eb5416493e1F070fb246763() {
        JSONObject dto = new JSONObject();
        // 支付场景
        dto.put("pay_scene", "1");
        // 手续费（%）
        ...
        // 实名认证信息
        // dto.put("al_real_name_info", getAa5f8b765dd440ceAe025cecebbc7aba());
        // *商户经营类目*
    ...
    private static JSON get157a52fb60ac4ca3Aed1A94eac5350f2() {
        JSONObject dto = new JSONObject();
        // 文件类型
    ...
    private static String get5218d02cA2c74ab2Adb57dbebed0cb10() {
        JSONObject dto = new JSONObject();
        // 申请类型
        ...
        // 文件列表
        // dto.put("file_list", get157a52fb60ac4ca3Aed1A94eac5350f2());
        // 联系人姓名
    ...
    private static JSON get81570945F3cf4bd5Ab01788b1f83b542() {
        JSONObject dto = new JSONObject();
    ...
    private static String getB7a9c72d94054b23A658Bc32683b9ed3() {
        JSONObject dto = new JSONObject();
        // 支付场景
        dto.put("pay_scene", "1");
        // 手续费（%）
        ...
        // dto.put("is_check_real_name", "");
        // 实名认证信息
        // dto.put("wx_real_name_info", get81570945F3cf4bd5Ab01788b1f83b542());
    ...
    private static JSON get669c1082878147d1Bbec0261e575f08e() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static JSON getAc4944d0D2944cbcB1ac66ab97f75b5c() {
        JSONObject dto = new JSONObject();
        // 联系人类型
        ...
        // dto.put("contact_file_list", get669c1082878147d1Bbec0261e575f08e());
        // 证件有效期类型
    ...
    private static JSON get265e74bd92c34d23A3abC7118fa2ede2() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static JSON get94de844c5b3d42559b4eC60668c61b3b() {
        JSONObject dto = new JSONObject();
        // 证件类型
        ...
        // 文件列表
        // dto.put("ubo_file_list", get265e74bd92c34d23A3abC7118fa2ede2());
        // 证件有效期截止日期
    ...
    private static JSON getA17dfa55A6b34fa59c372fba7dd8bc13() {
        JSONObject dto = new JSONObject();
        // 经营者/法人是否为受益人
        // dto.put("ubo_type", "test");
        // 受益人信息列表jsonArray格式,当ubo_type为Y时可不填
        // dto.put("ubo_info_list", get94de844c5b3d42559b4eC60668c61b3b());

        return dto;
    }

    private static JSON get593b812c1339445dA085F93791564e79() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static JSON getF310543c2c724b5d9a5bEebe2bc9726a() {
        JSONObject dto = new JSONObject();
        // 经营场景类型
        ...
        // 文件列表
        // dto.put("sales_scenes_file_list", get593b812c1339445dA085F93791564e79());
        // 文件列表
    ...
    private static JSON getB5990ec4Df30440286ddE3a1eb5beba7() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static JSON getE5873e28B8b54d3bAf425c167f6767aa() {
        JSONObject dto = new JSONObject();
        // 登记证书类型
        // dto.put("cert_type", "test");
        // 证书号
        ...
        // 文件列表
        // dto.put("cert_file_list", getB5990ec4Df30440286ddE3a1eb5beba7());
        // 证书有效期截止日期
    ...
    private static JSON getFae201c9B1d7498695fa5855b079d5af() {
        JSONObject dto = new JSONObject();
        // 账户类型
    ...
    private static JSON get30da06e6009143f98b9123ba3255d7cc() {
        JSONObject dto = new JSONObject();
        // 申请服务
    ...
    private static JSON get2b90819d34c441b2B19d5a0e0084c018() {
        JSONObject dto = new JSONObject();
        // 文件类型
        // dto.put("file_type", "test");
        // 文件jfileId
    ...
    private static String getBfd8a14f1c2d4465Ab68204aab071c0b() {
        JSONObject dto = new JSONObject();
        // 微信子商户号微信支付分配的子商户号；&lt;font color&#x3D;&quot;green&quot;&gt;示例值：1632157057&lt;/font&gt;
        // dto.put("sub_mch_id", "test");
        // 联系人信息jsonObject字符串,新增时必填
        // dto.put("contact_info", getAc4944d0D2944cbcB1ac66ab97f75b5c());
        // 最终受益人信息jsonObject字符串，商户类型为企业时，微信侧必填。（如果基本信息里有的话，可以不传取 huifu_id 对应的信息）。新增时填入
        // dto.put("ubo_info", getA17dfa55A6b34fa59c372fba7dd8bc13());
        // 经营场景jsonObject字符串，新增时填入
        // dto.put("sales_info", getF310543c2c724b5d9a5bEebe2bc9726a());
        // 特殊主体登记证书jsonObject字符串，商户营业执照类型为政府机关/事业单位/其他组织时，传入相应信息。新增时需填入
        // dto.put("certificate_info", getE5873e28B8b54d3bAf425c167f6767aa());
        // 银行账户信息jsonObject字符串，该字段不填时，取商户在汇付系统录入的结算账号信息。新增或修改时填入，修改时必填
        // dto.put("wx_card_info", getFae201c9B1d7498695fa5855b079d5af());
        // 配置集合对指定的sub_mch_id做配置
        // dto.put("wx_zl_pay_conf_list", get30da06e6009143f98b9123ba3255d7cc());
        // 操作类型ADD-新增， UPDATE-修改， 默认新增；&lt;font color&#x3D;&quot;green&quot;&gt;示例值：ADD&lt;/font&gt;
        // dto.put("operate_type", "test");
        // 补充说明信息
        // dto.put("business_addition_msg", "");
        // 补充说明文件列表
        // dto.put("addition_file_list", get2b90819d34c441b2B19d5a0e0084c018());

        return dto.toJSONString();
    }

    private static String get91dc4460855b49d283aeDd5b13718e59() {
        JSONObject dto = new JSONObject();
        // 借记卡手续费（%）
    ...
    private static String get95ffaa148541491a857c1a596057f811() {
        JSONObject dto = new JSONObject();
        // 借记卡手续费（%）
    ...
    private static String get02bb410b04024cd98bd557b227370b5d() {
        JSONObject dto = new JSONObject();
        // 业务类型
    ...
    private static String getD0ea2a0b7f58464d9bd14a5f4ac3b99e() {
        JSONObject dto = new JSONObject();
        // 业务类型
        // dto.put("pay_type", "");
        // 手续费外扣时的账户类型
    ...
    private static String getB90857126d054664855a2f2b7b9577aa() {
        JSONObject dto = new JSONObject();
        // *运营媒介类型*
    ...
    private static JSON getD099ce0cFbe14710B1bdB395e53db6a0() {
        JSONObject dto = new JSONObject();
    ...
    private static String getC093f60f23ba4738A58bF86aba0d3415() {
        JSONObject dto = new JSONObject();
        // *业务模式*
        // dto.put("balance_model", "test");
        // 业务情况说明
        // dto.put("description_info", getD099ce0cFbe14710B1bdB395e53db6a0());
        // 手续费(%)
        dto.put("fee_rate", "2");
        // 手续费（固定/元）
    ...
    private static JSON get15bf68f5Fa17492dBdeeB759a52e5970() {
        JSONObject dto = new JSONObject();
    ...
    private static JSON getFaa05513623d4b8fB5c6678f2284a822() {
        JSONObject dto = new JSONObject();
        // 开户手续费(元)
    ...
    private static String get2d6a049a386749beB57317d6b4c6d911() {
        JSONObject dto = new JSONObject();
        // 自动入账开关
        ...
        // dto.put("out_fee_huifuid", "");
        // 全域资金开户银行卡信息
        // dto.put("out_order_acct_card", get15bf68f5Fa17492dBdeeB759a52e5970());
        // 全域资金开户手续费
        // dto.put("out_order_acct_open_fees", getFaa05513623d4b8fB5c6678f2284a822());
        // 全域支付业务模式
    ...
    private static String getBfe028f4B9994c25Ba88669a42cbc40c() {
        JSONObject dto = new JSONObject();
        // 是否交易手续费外扣
    ...
    private static String get9e6683ad06534579B3415bc19a5be63f() {
        JSONObject dto = new JSONObject();
    ...
    private static JSON getDff92ddeFfce4524Adf8Aef25a1b95ea() {
        JSONObject dto = new JSONObject();
        // 分账比例
        // dto.put("fee_rate", "test");
        // 汇付Id
    ...
    private static JSON get18b6ffcb8bc94cf988754e5eea371df8() {
        JSONObject dto = new JSONObject();
        // *业务模式说明*
        // dto.put("busi_instruction", "test");
        // *资金流向说明*
    ...
    private static String get0b0568820b264abb9bef3e7712e2fbba() {
        JSONObject dto = new JSONObject();
        // 分账开关
        ...
        // dto.put("scene", "test");
        // 分账明细
        // dto.put("acct_split_bunch_list", getDff92ddeFfce4524Adf8Aef25a1b95ea());
        // 生效类型
        // dto.put("start_type", "");
        // 手续费外扣开关
        // dto.put("out_fee_flag", "");
        ...
        // dto.put("per_amt", "");
        // 业务情况说明
        // dto.put("split_ext_info", get18b6ffcb8bc94cf988754e5eea371df8());

        return dto.toJSONString();
    }

    private static String getFea2e375Ad9044b59a001ea1353898dc() {
        JSONObject dto = new JSONObject();
        // *文件id*
        // dto.put("file_id", "test");
        // *文件类型*
    ...
    private static String get7883a6dcA5f74c6eB90eC3fabe13e8e2() {
        JSONObject dto = new JSONObject();
        // *协议类型*
    ...
    private static String getA6ba1a0dD14544d7Bd01F8092622f28a() {
        JSONObject dto = new JSONObject();
    ...
    private static String get2a628c2cBc174240B2865e0949dcf96b() {
        JSONObject dto = new JSONObject();
        // 代发业务类型
    ...
    private static JSON getE1b2ee73Cad24e89B2085109267c6cd8() {
        JSONObject dto = new JSONObject();
        // 大额支付业务模式
    ...
    private static String getF241a679Acca455189d0E17c3b4709cf() {
        JSONObject dto = new JSONObject();
        // 大额支付配置列表
        // dto.put("large_amt_pay_config_info_list", getE1b2ee73Cad24e89B2085109267c6cd8());
    ...
    private static JSON getBc43f1ed4e464136B2087c2378dbb444() {
        JSONObject dto = new JSONObject();
        // 代发复核开关
    ...
    private static JSON getEc7183fbC9794f6e906cC71a68481ec6() {
        JSONObject dto = new JSONObject();
        // 操作人姓名
    ...
    private static JSON get3f9afc9bDf024af89b68380c4daff449() {
        JSONObject dto = new JSONObject();
        // 账户类型
        // dto.put("acct_type", "test");
        // 银行账户信息当账户类型为银行账户时必填
        // dto.put("jxf_bank_info", getEc7183fbC9794f6e906cC71a68481ec6());

        return dto;
    }

    private static JSON get5017570cFbaf44928f70B509b603cdf8() {
        JSONObject dto = new JSONObject();
        // 合单支付模式
    ...
    private static JSON get0390e26bFc4d42268f1c0535873e409f() {
        JSONObject dto = new JSONObject();
        // 合单支付开关
        // dto.put("merge_pay_flag", "test");
        // 合单支付配置合单支付配置 （当合单支付开关为开时必填）
        // dto.put("merge_pay_config", get5017570cFbaf44928f70B509b603cdf8());
