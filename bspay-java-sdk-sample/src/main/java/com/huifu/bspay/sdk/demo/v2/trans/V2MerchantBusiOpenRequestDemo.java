...
public class V2MerchantBusiOpenRequestDemo extends BaseCommonDemo {
    ...
    private static JSON get379752f64a884b988cef449231f1ce38() {
        ...
        dto.put("operator_phone", "13800138000");
        // 付款方账号
        dto.put("acct_no", "6222021001000000001");
        // 付款方账户名称
        dto.put("acct_name", "测试商户名称");
        // 开户行联行号
        dto.put("bank_branch_code", "102100099996");
        // 开户行行名
        dto.put("bank_branch_name", "中国工商银行北京分行");
        // 签约申请生效日期银行名称非平安银行时，需填写；示例：20251219
        dto.put("sign_start_date", "20260801");
        // 签约申请失效日期银行名称非平安银行时，需填写；示例：20261219
        dto.put("sign_end_date", "20270801");
        // 机构编码
        dto.put("org_code", "ORG1234567890");
        // 付款方账户类型
        dto.put("acct_type", "10");
        // 附言
        dto.put("remark", "测试附言");
