...
import com.huifu.bspay.sdk.opps.core.request.V2QuickbuckleWithholdQueryRequest;
 ...
 * @Description
 */
@Identify(requestClass = V2QuickbuckleWithholdQueryRequest.class)
public class V2QuickbuckleWithholdQueryRequestDemo extends BaseCommonDemo {
