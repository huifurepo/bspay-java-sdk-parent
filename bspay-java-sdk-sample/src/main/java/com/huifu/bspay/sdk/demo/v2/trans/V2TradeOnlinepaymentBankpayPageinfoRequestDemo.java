...
import com.huifu.bspay.sdk.opps.core.request.V2TradeOnlinepaymentBankpayPageinfoRequest;
 ...
 * @Description
 */
@Identify(requestClass = V2TradeOnlinepaymentBankpayPageinfoRequest.class)
public class V2TradeOnlinepaymentBankpayPageinfoRequestDemo extends BaseCommonDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 2.组装请求参数
        V2TradeOnlinepaymentBankpayPageinfoRequest request = new V2TradeOnlinepaymentBankpayPageinfoRequest();
        // 请求流水号
