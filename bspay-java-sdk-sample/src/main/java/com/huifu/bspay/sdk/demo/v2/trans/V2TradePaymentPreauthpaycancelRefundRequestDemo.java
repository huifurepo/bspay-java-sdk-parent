...
public class V2TradePaymentPreauthpaycancelRefundRequestDemo extends BaseCommonDemo {
    ...
    private static Map<String, Object> getExtendInfos() {
        ...
        // 设备信息
        extendInfoMap.put("terminal_device_info", getBcdb344248df41a3B8457e93f1e13808());
        // 异步通知地址
        extendInfoMap.put("notify_url", "http://www.baidu.com");
        return extendInfoMap;
    }

    private static String get017b50b636c74b53Af41081f2d992079() {
    ...
    private static String getBcdb344248df41a3B8457e93f1e13808() {
        JSONObject dto = new JSONObject();
        // 交易设备GPS
