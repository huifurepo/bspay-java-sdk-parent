...
public class V2TradePreauthpayRequestDemo extends BaseCommonDemo {
    ...
    private static Map<String, Object> getExtendInfos() {
        ...
        // 设备信息
        extendInfoMap.put("terminal_device_data", get4c12547917694abaBa1cBb866c7d5361());
        // 异步通知地址
        extendInfoMap.put("notify_url", "http://www.baidu.com");
        return extendInfoMap;
    }

    private static String get82649f29E7ed468bB63dCac763d0c52e() {
    ...
    private static String get4c12547917694abaBa1cBb866c7d5361() {
        JSONObject dto = new JSONObject();
        // 商户终端序列号
        dto.put("app_version", "");
        // 交易设备GPS
