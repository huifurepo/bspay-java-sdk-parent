...
public class V3TradePaymentMicropayRequestDemo extends BaseCommonDemo {
    ...
    private static Map<String, Object> getExtendInfos() {
        ...
        // 补贴支付信息
        // extendInfoMap.put("combinedpay_data", get5febf2895e58447188ca5473bb7f6305());
        // 场景类型
        // extendInfoMap.put("pay_scene", "");
        // 分账对象
        // extendInfoMap.put("acct_split_bunch", get98e9646aC3d64b1a887d32cab8c4a595());
        // 传入分帐遇到优惠的处理规则
        // extendInfoMap.put("term_div_coupon_type", "");
        // 聚合反扫微信参数集合
        // extendInfoMap.put("wx_data", get06986622B16c4d7c8f326a79db3de402());
        // 支付宝扩展参数集合
        // extendInfoMap.put("alipay_data", get2be5a39d44224aa0A33c4dc05a8ead66());
        // 银联参数集合
        // extendInfoMap.put("unionpay_data", get8339e69c43e947c9989e7bf9b6118e65());
        // 设备信息
        // extendInfoMap.put("terminal_device_info", get131eea4bF7d94e3f94ef52a5c3c3af91());
        // 异步通知地址
        ...
        // 手续费补贴信息
        // extendInfoMap.put("trans_fee_allowance_info", getFf9c1f9a77814781863741b3a9ff94d1());
    ...
    private static JSON get015eb18cCf624b1dA546Eb5050c0a1fd() {
        JSONObject dto = new JSONObject();
        // 分账接收方ID
        // dto.put("huifu_id", "test");
        // 分账金额
    ...
    private static String get98e9646aC3d64b1a887d32cab8c4a595() {
        JSONObject dto = new JSONObject();
        // 分账明细
        // dto.put("acct_infos", get015eb18cCf624b1dA546Eb5050c0a1fd());
        // 百分比分账标志
    ...
    private static JSON get0ebc49da62994543B8bf1aead7f5c9ad() {
        JSONObject dto = new JSONObject();
        // 商品编码
    ...
    private static JSON get236c6dce72ba459cA2175bf44bf0f2c5() {
        JSONObject dto = new JSONObject();
        // 单品列表
        // dto.put("goods_detail", get0ebc49da62994543B8bf1aead7f5c9ad());
        // 订单原价
        // dto.put("cost_price", "");
        // 商品小票ID
        // dto.put("receipt_id", "");
    ...
    private static JSON get6f9e0ab7F2ed4fec8e45C09c40738013() {
        JSONObject dto = new JSONObject();
        // 门店id
        // dto.put("id", "");
        // 门店名称
    ...
    private static JSON get4df9813eE2d74a35Ba7b547849fb364f() {
        JSONObject dto = new JSONObject();
        // 门店信息
        // dto.put("store_info", get6f9e0ab7F2ed4fec8e45C09c40738013());
    ...
    private static String get06986622B16c4d7c8f326a79db3de402() {
        ...
        // dto.put("attach", "");
        // 商品详情
        // dto.put("detail", get236c6dce72ba459cA2175bf44bf0f2c5());
        // 场景信息
        // dto.put("scene_info", get4df9813eE2d74a35Ba7b547849fb364f());
        // 单品优惠标识
    ...
    private static JSON getD19ec32a60b8463f890b8827e3a96ccf() {
        JSONObject dto = new JSONObject();
        // 商品的编号
        // dto.put("goods_id", "test");
        // 商品名称
    ...
    private static JSON getE25ed1dd69dd4dc7A612271c85cc69cf() {
        JSONObject dto = new JSONObject();
        // 卡类型
        // dto.put("card_type", "");
        // 支付宝点餐场景类型
    ...
    private static JSON get2dbce9dfA62e46069b315a6ff07682bd() {
        JSONObject dto = new JSONObject();
        // 姓名
        // dto.put("name", "");
        // 手机号
    ...
    private static String get2be5a39d44224aa0A33c4dc05a8ead66() {
        ...
        // 订单包含的商品列表信息
        // dto.put("goods_detail", getD19ec32a60b8463f890b8827e3a96ccf());
        // 业务扩展参数
        // dto.put("extend_params", getE25ed1dd69dd4dc7A612271c85cc69cf());
        // 商户操作员编号
        // dto.put("operator_id", "");
        // 商户门店编号
        // dto.put("store_id", "");
        // 外部指定买家
        // dto.put("ext_user_info", get2dbce9dfA62e46069b315a6ff07682bd());
        // 商户业务信息
