...
public class V2MerchantBusiOpenRequest extends BaseRequest {
     ...
     */
    @JSONField(name = "withhold_pay_scene")
    private String withholdPayScene;
    ...
    public V2MerchantBusiOpenRequest(String reqSeqId, String reqDate, String huifuId, String upperHuifuId, String signUserInfo, String onlineBusiType, String agreementInfo, String withholdPayScene) {
    ...
    public String getWithholdPayScene() {
        return withholdPayScene;
    }

    public void setWithholdPayScene(String withholdPayScene) {
        this.withholdPayScene = withholdPayScene;
    }
