 ...
 * @Description
 */
public class V2TradeOnlinepaymentBankpayPageinfoRequest extends BaseRequest {
    ...
    public V2TradeOnlinepaymentBankpayPageinfoRequest() {
    }

    public V2TradeOnlinepaymentBankpayPageinfoRequest(String reqSeqId, String reqDate, String huifuId, String transAmt, String goodsDesc, String extendPayData, String terminalDeviceData, String riskCheckData, String notifyUrl) {
